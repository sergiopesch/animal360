# Core Operations Implementation Assumptions
...
- Record types, packaged distribution, and advanced metadata-driven assessment work remain out of scope for this delivery slice.
...
- Starter reporting is delivered with a public read-only `Love 4 Animals` report folder and three baseline reports over the standard object report types.
